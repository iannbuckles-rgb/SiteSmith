...
| SCALE-005 | P1 | Run the compatibility preview under the shipped CSP. | Unscheduled | [Schedule](https://github.com/iannbuckles-rgb/SiteSmith/issues/new?template=roadmap.yml&title=%5BSCALE-005%5D%20CSP-compatible%20compatibility%20preview) |
